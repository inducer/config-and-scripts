...
\\let\\op=\\operatorname")
 ...
 '(package-selected-packages
   '(evil-collection flycheck-pycheckers markdown-mode flycheck editorconfig magit monokai-theme zenburn-theme nyx-theme dracula-theme nord-theme gruvbox-theme org-plus-contrib olivetti leuven-theme focus org-ref evil-easymotion base16-theme htmlize ox-gfm org helm zoom-frm color-theme-solarized evil evil-org company))
